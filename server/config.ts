...
export default {
  ...
  apis: {
    ...
    digitalCanteenApi: {
      ...
      healthPath: '/health/ping',
      timeout: {
        response: Number(get('DIGITAL_CANTEEN_API_TIMEOUT_RESPONSE', 5000)),
        deadline: Number(get('DIGITAL_CANTEEN_API_TIMEOUT_DEADLINE', 5000)),
      },
      agent: new AgentConfig(Number(get('DIGITAL_CANTEEN_API_TIMEOUT_RESPONSE', 5000))),
    },
  },
  sqs: {
    audit: auditConfig(),
