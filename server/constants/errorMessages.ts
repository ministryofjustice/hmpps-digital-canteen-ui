const ERROR_MESSAGE = {
  RADIO_OPTION_NOT_SELECTED_ERROR: 'Choose the amount of credit to buy or add your own.',
  INVALID_AMOUNT_ERROR: 'Enter how much credit you want in numbers, for example, 0.05 or 10.00.',
